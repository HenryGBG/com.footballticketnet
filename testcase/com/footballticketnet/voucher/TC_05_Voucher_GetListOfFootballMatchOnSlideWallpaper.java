...
public class TC_05_Voucher_GetListOfFootballMatchOnSlideWallpaper extends BaseTest {
	WebDriver driver;
	...
	public void Voucher_TC001_Buy_With_Empty_Data(Method method) {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Voucher - Step 01: Get the list of Football matches on slide wallpaper");
